...
export const users = sqliteTable("users", {
  ...
  role: text("role", { enum: ["user", "admin", "institution", "editor", "dri"] }).notNull().default("user"),
  status: text("status", { enum: ["pending", "approved", "rejected"] }).notNull().default("pending"),
  rejectionReason: text("rejection_reason"),
  institutionName: text("institution_name"), // Para rol "institution"
  ministry: text("ministry"), // Para rol "dri" (MES, MINSAP, etc.)
...
export const graduates = sqliteTable("graduates", {
  ...
  pregradoModalidad: text("pregrado_modalidad", { enum: ["becario", "financiado_gobierno", "autofinanciado"] }),
  postgradoUniversity: text("postgrado_university"),
  postgradoProgram: text("postgrado_program", { enum: ["maestria", "doctorado", "especialidad"] }),
  postgradoYear: integer("postgrado_year"),
  otherAcademicProgram: text("other_academic_program"),
  otherCubanInstitution: text("other_cuban_institution"),
...
// Lista de universidades cubanas oficial
